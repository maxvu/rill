...
#define RILL_LEX_CHAR_QUOTE_SINGLE       '\''
#define RILL_LEX_CHAR_QUOTE_DOUBLE       '"'
...
#define RILL_LEX_CHAR_WORD_DEFINITION_BEGIN  RILL_LEX_CHAR_COLON
#define RILL_LEX_CHAR_WORD_DEFINITION_END    RILL_LEX_CHAR_SEMICOLON
...
#define RILL_LEX_CHAR_STRING_DELIM_SINGLE    RILL_LEX_CHAR_QUOTE_SINGLE
#define RILL_LEX_CHAR_STRING_DELIM_DOUBLE    RILL_LEX_CHAR_QUOTE_DOUBLE
