...
#define RILL_LEX_CHAR_F_LOWER            'f'
#define RILL_LEX_CHAR_N_LOWER            'n'
#define RILL_LEX_CHAR_R_LOWER            'r'
#define RILL_LEX_CHAR_BACKSLASH          '\\'
#define RILL_LEX_CHAR_QUOTEMARK_SINGLE   '\''
#define RILL_LEX_CHAR_QUOTEMARK_DOUBLE   '"'

/* language syntax */
#define RILL_LEX_CHAR_STRUCT_BEGIN           RILL_LEX_CHAR_LEFT_CURLY_BRACE
#define RILL_LEX_CHAR_STRUCT_END             RILL_LEX_CHAR_RIGHT_CURLY_BRACE
