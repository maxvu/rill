#ifndef RILL_VM_OPCODE
#define RILL_VM_OPCODE
...
enum opcode {
    ...
    UDIV = 21, // division
    USFT = 22, // bitwise shift (positive goes left)
    ...
    SNEW = 39, // create new, empty buffer
    SCAT = 40, // concatenate TOS and TOS-1
    SLEN = 41, // length
    SCMP = 42, // compare TOS and TOS-1
    ...
    RRT  = 60, // reverse-rotate, inverse of ROT
    ...
    DU00 = 71,  // load immediate value 02
    DU01 = 72,  // load immediate value 03
    DU02 = 73,  // load immediate value 04
    DU03 = 74,  // load immediate value 05
    DU04 = 75,  // load immediate value 06
    DU05 = 76,  // load immediate value 07
    DU06 = 77,  // load immediate value 08
    DU07 = 78,  // load immediate value 09
    DU08 = 79,  // load immediate value 10
    DU09 = 80,  // load immediate value 11
    DU10 = 81,  // load immediate value 12
